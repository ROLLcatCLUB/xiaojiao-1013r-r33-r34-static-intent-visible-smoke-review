...
SLOT_SELECTOR_MAP = {
    ...
    "courseware_script": ".courseware-screen-mini, .courseware-screen-card, .courseware-screen-row, [data-r21-field-anchor='derivative_linkage']",
    "classroom_display_screen": ".courseware-screen-mini, .courseware-screen-card, .courseware-screen-row, [data-r21-field-anchor='derivative_linkage']",
    "worksheet": "[data-r32-derivative-id='worksheet'], [data-r21-field-anchor='derivative_linkage']",
    "assessment_rubric": "[data-r32-derivative-id='assessment_rubric'], [data-r21-field-anchor='derivative_linkage']",
    ...
    "confirm_actions": ".nb-drawer, .nb-right-rail, [data-r21-field-anchor='action_gate']",
    "bottom_composer": ".xiaobei-chat-entry, #chatInput, #statusMain",
}


TOOL_SLOT_MAP = {
    "prep_notebook": ["lesson_body", "teaching_process"],
    "prep_room_home": ["current_object_card", "xiaojiao_task_state"],
    "big_unit_design": ["lesson_body", "teaching_process", "source_evidence"],
    "single_lesson_prep": ["lesson_body", "teaching_process"],
    "courseware_workspace": ["courseware_script", "classroom_display_screen"],
    ...
    "teacher_action_gate": ["confirm_actions"],
